...
const allTags = async (req, res) => {
  ...
  try {
    ...
    if (tags.length > 0) return ApiResponse(res, 200, "Tags found", tags);
    else if (tags) return ApiResponse(res, 200, "No tags are added", tags);
    else return ApiResponse(res, 400, "Something went wrong");
  } catch (e) {
